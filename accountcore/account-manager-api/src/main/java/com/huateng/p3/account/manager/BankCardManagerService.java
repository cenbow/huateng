...
public interface BankCardManagerService {
	 ...
	 * @return
	 */
	public Response<String> bindBankCard(TInfoBankcard bankCard,String bindingType, TInfoCustomer customer, ManagerLog managerLog);
	 ...
	 * @return
	 */
	public Response<String> unbindBankCardByBankCardNo(TInfoBankcard bankCard, TInfoCustomer customer, ManagerLog managerLog);
