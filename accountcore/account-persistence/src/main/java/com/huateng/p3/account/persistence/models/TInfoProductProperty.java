...
@ToString
public class TInfoProductProperty  implements Serializable{
    
	private static final long serialVersionUID = 8665798098879153960L;
    ...
    public TInfoProductProperty(){
    }

    public TInfoProductProperty(String id, String productNo, String productName, String productCode,
                                String accountNo,String customerNo,String areaCode,String cityCode, String productStatus,
                                String txnStatus, String lastUpdateTime, String createTime, String achievedTime,String archivedFlag) {
        super();
        this.id = id;
        this.productNo = productNo;
        this.productName = productName;
