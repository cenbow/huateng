...
import com.huateng.p3.hub.componentservice.CacheComponent;
...
public class SequenceGenerator {
    ...
    public String generateCustomerNo(String areaCode, String cityCode) {
        ...
        return "8630"
                + teleCode
                + Strings.padStart(sequenceDao.produceSequence("s_account_no_" + extractProvCode(areaCode)), 9, '0');
    }
    ...
    public String generatorTxnSeqNo() {
        return generateSeq(SeqPlatType.SEQ_TRANA_ACCOUNT_CODE.getPlatcode(),
                SeqPlatBussKind.SEQ_TRANA_TYPE.getSeqkingcode(),
                SeqCoreTranType.TRANS_SEQ_TYPE_NORMAL.getTrancoreseqtypecode(), "s_account_online_txn_seq");
    }
    ...
    public String generatorRefundTxnSeqNo() {
        return generateSeq(SeqPlatType.SEQ_TRANA_ACCOUNT_CODE.getPlatcode(),
                SeqPlatBussKind.SEQ_TRANA_TYPE.getSeqkingcode(),
                SeqCoreTranType.TRANS_SEQ_TYPE_REFUND.getTrancoreseqtypecode(), "s_account_online_txn_seq");
    }
	...
	public  String generateAuthenticationInfoSeqVal() {
		return DateTime.now().toString("yyyyMMdd") + 
				StringUtil.fillLeft(sequenceDao.produceSequence("S_T_REALNAME_APPLY"), '0', 10);
	}
	public  String generateAccountMgmTxnSeq() {
		return generateSeq(SeqPlatType.SEQ_TRANA_ACCOUNT_CODE.getPlatcode(),
	                SeqPlatBussKind.SEQ_MANAGER_TYPE.getSeqkingcode(),
	                SeqCoreTranType.TRANS_SEQ_TYPE_NORMAL.getTrancoreseqtypecode(), "S_LOG_ACCOUNT_MANAGEMENT");
	}
	
	
	public String generatorRefundApplySeq() {
		return "1" + StringUtil.fillLeft(sequenceDao.produceSequence("s_t_log_refund_apply"), '0', 19);
    }
