  ...
  var Validator = function ( options ) {
    ...
    */
    this.messages = {
      ...
      , notequalto:     "This value should be the difference."
    },
  ...
  ParsleyField.prototype = {
    ...
    */
    , ulErrorManagement: function () {
      ...
      this.ulTemplate = $( this.options.errors.errorsWrapper ).attr( 'id', this.hash ).addClass( 'parsley-error-list' ).css("color","red");
    }
