module.exports = {
	init: function() {
		...
		$(".inqu").click(function() {
			...
			$(this).parent().children().removeClass("sel-inqu").addClass("inqu");
			// $(".fen-border01 a").removeClass("inq-fl01-sel").removeClass("inq-fl01-hov").addClass("inq-fl01");
			$(this).addClass("sel-inqu");
			if ($(this).attr('id') == '11' || $(this).attr('id') == '12' || $(this).attr('id') == '13' || $(this).attr('id') == '22' || $(this).attr('id') == '39') {
		...
		$(".inqu").click(function(){
			...
			$(this).addClass("sel-inqu");
			if($(this).attr('id')=='01'||$(this).attr('id')=='02'||$(this).attr('id')=='03'){
			   $("#feeType").val($(this).attr('id'));
			}else if ($(this).attr('id')=='F'){
			   $("#feeType").val('');
			}
